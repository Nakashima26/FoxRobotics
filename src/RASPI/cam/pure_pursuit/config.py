...
# Frames tras que un obstáculo se pasa (pasado=True) durante los cuales se
# apaga la "urgencia frontal por pared" en detect_centerline() aunque
# bev_obstacles quede vacío -- ver suppress_wall_urgency. La mancha de color
# del objeto (untado en el BEV por la homografía, ver OBS_REAL_DIAMETER_MM)
# sigue siendo visible en cámara unos frames más aunque la memoria ya lo haya
# soltado, y sin este cooldown esa mancha puede leerse como "pared" justo
# cuando esa protección deja de aplicar (dejaba de correr solo mientras el
# objeto seguía en bev_obstacles). Ajustar en pista si hace falta más/menos.
OBS_PASSED_COOLDOWN_FRAMES = 2
